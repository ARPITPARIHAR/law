                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="{{ route('admin.banner.create') }}">
                                                <span class="pcoded-mtext">Edit Banner</span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="{{ route('admin.contact.create') }}">
                                                <span class="pcoded-mtext">Edit contact info</span>
                                            </a>
                                        </li>
                            ...
                            <div class="main-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    $('.dropdown-toggle').dropdown(); // Initialize dropdown toggle
                                                });
                                            </script>
                                            <!-- Include jQuery -->
                                ...
                                <script>
                                    window.addEventListener('wheel', function(event) {
                                        event.preventDefault(); // Attempting to prevent default action
                                    }, { passive: false });
                                </script>
                 <style>
                .sidebar {
